...
public class ListenerPractice {
	...
	private int rectX = width/2, rectY = height/2;
	
	// variable to keep track of our speed.
	private int rectSpeed = 0;
	private int rectVerticalSpeed = 0;
	...
	public ListenerPractice() {
		...
		frame.add(new JPanel() {
			...
			public void paint(Graphics g) {
				...
				g.setColor(new Color(135,180,70));
				g.fillRect(rectX, rectY, rectWidth, rectHeight);
				
				g.drawString("Press i for moving up", 50, 50);
				g.drawString("Press m for moving down", 50, 65);
				g.drawString("Press k for moving right", 50, 80);
				g.drawString("Press j for moving left", 50, 95);
